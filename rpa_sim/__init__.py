...
from .rpa_logic import (
    ...
    OFFSET_CONTROL_BLOCK_SIZE, OFFSET_DOMAIN_ID, OFFSET_TRAP_VECTOR,
    OFFSET_INTERRUPT_CONTROLLER, OFFSET_IPA_REGIONS, OFFSET_PAGE_TABLE,
    OFFSET_CHILD_BLOCK, OFFSET_SECURITY_GROUP, OFFSET_ISA_TAG,
